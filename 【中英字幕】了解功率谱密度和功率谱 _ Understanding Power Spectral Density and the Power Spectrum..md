...
186
0:11:1,6 --> 0:11:6,4
因为我们之前讨论的求和由于没有完整的周期而无法完全抵消。

187
0:11:6,42 --> 0:11:9,54
缓解这种情况的一种方法是使用更长的时间序列，
...
190
0:11:14,7 --> 0:11:19,8
但如果这不可能，那么另一种方法是对数据应用非矩形窗口，

191
0:11:19,8 --> 0:11:27,5
比如hamming窗，它会衰减边缘附近的信号，从而减少部分周期的影响。
...
250
0:15:4,3 --> 0:15:9,7
在这个图中，我展示了100到100.5赫兹之间的50个正弦波。
...
272
0:16:35,23 --> 0:16:37,15
它将其乘以1。

273
0:16:37,1 --> 0:16:41,6
因此，通过这种方式，我们可以准确地从单个正弦波中获取功率。
...
324
0:19:44,89 --> 0:19:47,59
然而，如果有宽带信号，

325
0:19:47,59 --> 0:19:50,14
那么查看功率谱密度可能更有意义，

326
0:19:50,14 --> 0:19:54,8
因为它返回的是每个频带的功率。
